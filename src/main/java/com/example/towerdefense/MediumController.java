...
public class MediumController implements DraggableTowers {
    ...
    public void switchToMedium(ActionEvent event, String name) throws IOException {
        root = FXMLLoader.load(getClass().getResource("initialMediumScreen.fxml"));
    ...
    private AnimationTimer collisionTimer3 = new AnimationTimer() {
        ...
        public void handle(long time) {
            if (tower1Box.getImage() == upgradedSkyscraper) {
                checkEnemy2InRange(0.02);
            } else if (tower2Box.getImage() == upgradedCastle) {
                checkEnemy2InRange(0.02);
            } else if (tower3Box.getImage() == upgradedRoman) {
                checkEnemy2InRange(0.02);
            } else {
                checkEnemy2InRange(0.002);
            }
        }
    };
    ...
    private AnimationTimer collisionTimer4 = new AnimationTimer() {
        ...
        public void handle(long time) {
            if (tower1Box.getImage() == upgradedSkyscraper) {
                checkEnemy3InRange(0.01);
            } else if (tower2Box.getImage() == upgradedCastle) {
                checkEnemy3InRange(0.01);
            } else if (tower3Box.getImage() == upgradedRoman) {
                checkEnemy3InRange(0.01);
            } else {
                checkEnemy3InRange(0.002);
            }
        }
    };
    ...
    private AnimationTimer collisionTimer5 = new AnimationTimer() {
        ...
        public void handle(long time) {
            if (tower1Box.getImage() == upgradedSkyscraper) {
                checkBossInRange(0.01);
            } else if (tower2Box.getImage() == upgradedCastle) {
                checkBossInRange(0.01);
            } else if (tower3Box.getImage() == upgradedRoman) {
                checkBossInRange(0.01);
            } else {
                checkBossInRange(0.001);
            }
        }
    };
    ...
    public void checkEnemy1InRange(double attack) {
        if (enemyBox.getBoundsInParent().intersects(
                ...
                tower1Box.getBoundsInParent().getWidth() + 90,
                tower1Box.getBoundsInParent().getHeight() + 90) || enemyBox.getBoundsInParent().intersects(
                tower2Box.getBoundsInParent().getMinX() - 35,
                tower2Box.getBoundsInParent().getMinY() - 35,
                tower2Box.getBoundsInParent().getWidth() + 60,
                tower2Box.getBoundsInParent().getHeight() + 60) || enemyBox.getBoundsInParent().intersects(
                tower3Box.getBoundsInParent().getMinX() - 35,
                tower3Box.getBoundsInParent().getMinY() - 35,
                tower3Box.getBoundsInParent().getWidth() + 70,
                tower3Box.getBoundsInParent().getHeight() + 70)) {
    ...
    public void checkEnemy2InRange(double attack) {
        if (enemyBox2.getBoundsInParent().intersects(
                ...
                tower1Box.getBoundsInParent().getMinY() - 35,
                tower1Box.getBoundsInParent().getWidth() + 90,
                tower1Box.getBoundsInParent().getHeight() + 90) || enemyBox2.getBoundsInParent().intersects(
                tower2Box.getBoundsInParent().getMinX() - 35,
                tower2Box.getBoundsInParent().getMinY() - 35,
                tower2Box.getBoundsInParent().getWidth() + 60,
                tower2Box.getBoundsInParent().getHeight() + 60) || enemyBox2.getBoundsInParent().intersects(
                tower3Box.getBoundsInParent().getMinX() - 35,
                tower3Box.getBoundsInParent().getMinY() - 35,
                tower3Box.getBoundsInParent().getWidth() + 70,
                tower3Box.getBoundsInParent().getHeight() + 70)) {
    ...
    public void checkEnemy3InRange(double attack) {
        if (enemyBox3.getBoundsInParent().intersects(
                ...
                tower1Box.getBoundsInParent().getMinY() - 35,
                tower1Box.getBoundsInParent().getWidth() + 90,
                tower1Box.getBoundsInParent().getHeight() + 90) || enemyBox3.getBoundsInParent().intersects(
                tower2Box.getBoundsInParent().getMinX() - 35,
                tower2Box.getBoundsInParent().getMinY() - 35,
                tower2Box.getBoundsInParent().getWidth() + 60,
                tower2Box.getBoundsInParent().getHeight() + 60) || enemyBox3.getBoundsInParent().intersects(
                tower3Box.getBoundsInParent().getMinX() - 35,
                tower3Box.getBoundsInParent().getMinY() - 35,
                tower3Box.getBoundsInParent().getWidth() + 70,
                tower3Box.getBoundsInParent().getHeight() + 70)) {
    ...
    public void checkBossInRange(double attack) {
        if (finalBox.getBoundsInParent().intersects(
                ...
                tower1Box.getBoundsInParent().getMinY() - 35,
                tower1Box.getBoundsInParent().getWidth() + 90,
                tower1Box.getBoundsInParent().getHeight() + 90) || finalBox.getBoundsInParent().intersects(
                tower2Box.getBoundsInParent().getMinX() - 35,
                tower2Box.getBoundsInParent().getMinY() - 35,
                tower2Box.getBoundsInParent().getWidth() + 60,
                tower2Box.getBoundsInParent().getHeight() + 60) || finalBox.getBoundsInParent().intersects(
                tower3Box.getBoundsInParent().getMinX() - 35,
                tower3Box.getBoundsInParent().getMinY() - 35,
                tower3Box.getBoundsInParent().getWidth() + 70,
                tower3Box.getBoundsInParent().getHeight() + 70)) {
    ...
    public void move(ImageView enemy, ImageView enemy2, ImageView enemy3) {
        ...
        path01.getElements().add(new LineTo(360, 25));
        path01.getElements().add(new LineTo(360, 170));
        path01.getElements().add(new LineTo(70, 170));
        path01.getElements().add(new LineTo(70, 330));
        path01.getElements().add(new LineTo(360, 330));
        path01.getElements().add(new LineTo(360, 450));
        ...
        path02.getElements().add(new LineTo(430, 25));
        path02.getElements().add(new LineTo(430, 170));
        path02.getElements().add(new LineTo(130, 170));
        path02.getElements().add(new LineTo(130, 330));
        path02.getElements().add(new LineTo(430, 330));
        path02.getElements().add(new LineTo(430, 450));
        ...
        path03.getElements().add(new LineTo(470, 25));
        path03.getElements().add(new LineTo(470, 170));
        path03.getElements().add(new LineTo(180, 170));
        path03.getElements().add(new LineTo(180, 330));
        path03.getElements().add(new LineTo(470, 330));
        path03.getElements().add(new LineTo(470, 450));

        transition3.setNode(enemyBox3);
        transition3.setDuration(Duration.seconds(45));
    ...
    public void moveFinalBoss(ImageView boss) {
        ...
        path04.getElements().add(new LineTo(730, 25));
        path04.getElements().add(new LineTo(730, 170));
        path04.getElements().add(new LineTo(435, 170));
        path04.getElements().add(new LineTo(435, 330));
        path04.getElements().add(new LineTo(730, 330));
        path04.getElements().add(new LineTo(730, 450));

        transition4.setNode(finalBox);
        transition4.setDuration(Duration.seconds(50));
